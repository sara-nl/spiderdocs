...
The public dashboard can be found `here <https://jobsview.grid.surfsara.nl/grafana/?orgId=1>`__ and shows 4 views of running jobs, pending jobs, queue times and reserved number of cores for the cluster for different projects.
