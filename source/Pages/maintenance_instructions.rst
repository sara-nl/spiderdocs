...
- CentOS 8 does not provide to users a python interpreter, only python3. If you still need python2, we advise you to use conda or Singularity containers to create an execution environment tailored to your preferred python version or contact us for help.
