...
.. note::
   ...
   In case that you have multiple keys in your ``.ssh/`` folder, you would need to specify the key that matches the .pub file you uploaded on the SURF CUA portal, i.e. ``ssh -i ~/.ssh/surfkey homer@spider.surf.nl``
...
.. note::
   ...
   ``SHA256:b7TbyARI6AQRrNCulsPoNtRl20zW2OeV/bvxPUWuu90 (ED25519)``
...
======================   ============
``sinfo``                displays the worker nodes information
